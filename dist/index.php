...
<body>
    <div class="flex flex-wrap overflow-hidden">
        ...
        <div class="flex flex-col bg-white shadow-lg rounded-lg border border-gray-200 h-[400px] relative"
            style="flex: 1;">
            <!-- Background image -->
                    ...
                    <div class="relative py-2">
                        ...
                        <div class="overflow-hidden h-[28px] text-xs flex rounded bg-teal-200">
                            <div id="progressBar" style="width: 0%;"
                                class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-teal-500 transition-all duration-1000 ease-in-out">
                            </div>
                        </div>
                    </div>
                </div>
