<div class="flex flex-row gap-4 w-full pr-8 mb-8">
    ...
    <div class="basis-2/3 shadow border border-gray-300 rounded-lg p-4 flex flex-col">
        <!-- Title -->
        <h1 class="text-2xl font-bold mb-4">Latest Comments&nbsp;<span class="text-slate-300 font-medium ml-1">(3)</span>
        </h1>
        ...
        <div class="space-y-4 flex-grow">
            ...
            <div id="entry1" class="flex items-center bg-white hover:bg-gray-100 p-4 rounded-lg hover:shadow-sm">
                ...
                <div class="w-16 h-16 flex-shrink-0">
                    <img src="img/team/employee_1.webp" alt="Employee Image" class="w-full h-full object-cover rounded-full">
                </div>
                ...
                <div class="ml-4">
                    <div class="flex items-center">
                        ...
                        <!-- Alert Circle -->
                        <span class="ml-1 bg-red-200 font-medium text-red-500 rounded-full w-5 h-5 text-center text-xs leading-5">3</span>
                    </div>
                ...
                <div class="ml-auto flex items-center">
                    ...
                    <!-- New Circle -->
                    <div class="check-circle ml-4 w-6 h-6 border border-gray-400 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-300" data-entry="entry1">
            ...
            <div id="entry2" class="flex items-center bg-gray-50 hover:bg-gray-100 p-4 rounded-lg hover:shadow-sm">
                <!-- User Image -->
                <div class="w-16 h-16 flex-shrink-0">
                    <img src="img/team/employee_2.webp" alt="Employee Image" class="w-full h-full object-cover rounded-full">
                </div>
                <!-- Name and Description -->
                <div class="ml-4">
                    <div class="flex items-center">
                        ...
                        <!-- Alert Circle -->
                        <span class="ml-1 bg-red-200 font-medium text-red-500 rounded-full w-5 h-5 text-center text-xs leading-5">2</span>
                    </div>
                ...
                <div class="ml-auto flex items-center">
                    ...
                    <!-- New Circle -->
                    <div class="check-circle ml-4 w-6 h-6 border border-gray-400 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-300" data-entry="entry2">
                        <div class="checkmark hidden">
                            ✓
                        </div>
                    </div>
    ...
    <div class="basis-1/6 shadow border border-gray-300 rounded-lg p-4">
        Coming Soon...
    </div>
</div>
</div>
...
<div class="flex justify-between items-center w-full  pr-20 px-10 mb-2">
    ...
    <div class="text-gray-400 flex items-center font-medium">
        <svg class="fill-gray-500 inline-block mr-2" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
            <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
            <path d="M176 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h16V98.4C92.3 113.8 16 200 16 304c0 114.9 93.1 208 208 208s208-93.1 208-208c0-41.8-12.3-80.7-33.5-113.2l24.1-24.1c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L355.7 143c-28.1-23-62.2-38.8-99.7-44.6V64h16c17.7 0 32-14.3 32-32s-14.3-32-32-32H224 176z" />
        </svg>
        6h&nbsp;5min
    </div>
</div>
    ...
    <div class="relative flex-grow border border-gray-300 rounded-lg">
        <div class="overflow-x-auto rounded-lg">
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                    <tr>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50">TCL
                            Marketing</th>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center h-full">
                                <span class="flex-shrink-0">Video</span>
                                <div class="ml-2 h-[25px] w-[25px] bg-red-200 rounded-full flex items-center justify-center flex-shrink-0" data-notify="entry1">
                        ...
                        <td class="px-6 py-4 bg-gray-50">Short ad for Product X</td>
                        <td class="px-6 py-4">1080p</td>
                        <td class="px-6 py-4 bg-gray-50">January</td>
                        <td class="px-6 py-auto relative">
                            <div class=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-6 text-xs flex rounded bg-teal-200 w-11/12 ">
                                <div style="width: 60%;" class="p-2 shadow-none flex flex-col text-left whitespace-nowrap rounded font-bold text-white justify-center bg-teal-500 progress-bar">
                                    54
                                </div>
                            </div>
                        </td>
                        <td class="py-4 mt-1 flex space-x-4 justify-center flex-row gap-4">
                            ...
                            <div class="text-center flex align-center justify-center gap-4">
                                ...
                                <button class="focus:outline-none">
                                    <svg class="fill-gray-400 hover:fill-gray-800 duration-300" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                                        <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                ...
                                <!-- Delete Icon -->
                                <button class="focus:outline-none">
                                    <svg class="fill-gray-400 hover:fill-gray-800 duration-300" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
                                        <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-auto relative">
                            <div class=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-6 text-xs flex rounded bg-teal-200 w-11/12">
                                <div style="width: 30%;" class="p-2 shadow-none flex flex-col text-left whitespace-nowrap rounded font-bold text-white justify-center bg-teal-500">
                                    27
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 bg-gray-50">
                            <div class="flex items-center h-full">
                                <span>March</span>
                                <div class="ml-2 h-[25px] w-[25px] bg-red-200 rounded-full flex items-center justify-center" data-notify="entry2">
        ...
        <td class="px-6 py-auto relative">
            <div class=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-6 text-xs flex rounded bg-teal-200 w-11/12">
                <div style="width: 10%;" class="p-2 shadow-none flex flex-col text-left whitespace-nowrap rounded font-bold text-white justify-center bg-teal-500">
                    9
                </div>
            </div>
        </td>
