        ...
        <div class="flex flex-grow flex-col justify-center space-y-4 w-2/3 ml-4 pl-4 mb-6">
            <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 ">
                <ul class="flex flex-wrap -mb-px">
                    ...
                    <li class="mr-2">
                        <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 ">Offers</a>
                    </li>

                    <li class="mr-2">
                        <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 ">Creative</a>
                    </li>
                    <li class="mr-2">
                        <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 ">Tracking</a>
                    </li>
                    <li>
        ...
        <div class="flex flex-row w-full gap-4 mx-8 pr-16 mb-8">
            <div class="bg-white rounded-lg  p-6 w-1/4 border border-gray-300">
                ...
                <div class="flex flex-row mt-2">
                    <div class="basis-1/3">
                        <p class="text-slate-600 font-light text-sm">Phone</p> <a href="tel:814-693-0133" class="text-blue-500">814-693-0133</a>
                    </div>
                    <div class="basis-1/3">
                ...
                <div class="text-center w-full border border-slate-300 py-2 rounded-lg mt-4 duration-500 hover:bg-gray-100">
            ...
            <div class="bg-white rounded-lg p-6 w-1/4 border border-gray-300">
                ...
                <ul class="text-sm list-inside space-y-1">
                    <div class="my-2 pt-2 border-b border-gray-100">
                        <li>
                            <div class="flex flex-row items-center gap-2 w-full mb-2">
                                <a href="http://fb.windowworlddeals.com/altoona" class="flex gap-2 items-center text-blue-500 ">
                        ...
                        <li>
                            <div class="flex flex-row items-center gap-2 w-full mb-2">
                                <a href="http://fb.windowworlddeals.com/altoona-2" class="flex gap-2 items-center text-blue-500 ">
                                    <span class="bg-blue-100 text-blue-600 p-1 rounded-full text-xs px-4 ">FB</span>
                    ...
                    <li>
                        <div class="flex flex-row items-center gap-2 w-full mb-2">
                            <a href="http://ppc.windowworlddeals.com/altoona" class="flex gap-2 items-center text-blue-500 ">
                    ...
                    <li>
                        <div class="flex flex-row items-center gap-2 w-full mb-2">
                            <a href="http://ppc.windowworlddeals.com/altoona-nb" class="flex gap-2 items-center text-blue-500 ">
                                <span class="bg-yellow-100 text-yellow-600 p-1 rounded-full text-xs px-3 ">PPC</span>
                    ...
                    <li>
                        <div class="flex flex-row items-center gap-2 w-full mb-2">
                            <a href="http://ppc.windowworlddeals.com/altoona-comp" class="flex gap-2 items-center text-blue-500 ">
                                <span class="bg-yellow-100 text-yellow-600 p-1 rounded-full text-xs px-3 ">PPC</span>
            ...
            <div class="bg-white rounded-lg border p-6 w-1/4  border-gray-300">
                ...
                <ul class="text-sm list-inside space-y-1">
                    <li>
                        <div class="flex flex-row items-center gap-4 w-full mb-2 p-2 rounded cursor-pointer duration-500 hover:bg-slate-100">
                            <a href="https://www.facebook.com/WindowWorldAltoona" class="flex gap-4 items-center text-blue-500 align-middle justify-center">
                                <span class="icon-container bg-emerald-100 text-emerald-600 p-1 duration-500 rounded text-xs w-10 h-10 flex items-center justify-center group-hover:bg-emerald-200">
                                    <img class="icon w-full h-full object-cover group-hover:hidden" src="img/icons/green_leaf.svg" />
                                    <img class="icon-hover w-full h-full object-cover hidden group-hover:block" src="img/icons/green_leaf_d.svg" />
                                </span>
                    ...
                    <li class="group">
                        <div class="flex flex-row items-center gap-4 w-full mb-2 p-2 rounded cursor-pointer duration-500 hover:bg-slate-100">
                            <a href="https://www.facebook.com/WindowWorldAltoona" class="flex gap-4 items-center text-blue-500 align-middle justify-center">
                                <span class="bg-blue-500 text-blue-600 p-1 rounded text-xs w-10 h-10 flex items-center justify-center duration-500 group-hover:bg-blue-600">
                    ...
                    <li class="group">
                        <div class="flex flex-row items-center gap-4 w-full mb-2 p-2 rounded cursor-pointer duration-500 hover:bg-slate-100">
                            <a href="https://www.facebook.com/WindowWorldAltoona" class="flex gap-4 items-center text-blue-500 align-middle justify-center">
                                <span class="bg-gray-200 text-blue-600 p-1 rounded text-xs w-10 h-10 flex items-center justify-center duration-500 group-hover:bg-gray-300">
                                    <img class="duration-500 opacity-70 group-hover:opacity-100" src="img\logos\Google_G.svg" />
                                </span>
            ...
            <div class="bg-white rounded-lg g p-6 w-1/4 border border-gray-300">
                ...
                <div class="p-1 pt-4 pb-4 rounded-lg z-10">
                    ...
                    <!-- Alert Box -->
                    <div class="flex items-center p-4 text-sm text-gray-800 border border-gray-300 rounded-lg bg-gray-50 relative" role="alert">
                        ...
                        <!-- Popup Card -->
                        <div id="popup-card" class="hidden absolute top-0 right-0 mt-12 w-64 p-4 bg-white border border-gray-300 rounded shadow-lg">
                            <h4 class="text-lg font-semibold mb-2">Details</h4>
                            <p>Change Saturday hours to by appointment only starting from 9/11/2023.</p>

                            <span class="bg-gray-100 text-gray-800 text-xs font-medium inline-flex items-center px-1 py-1 rounded mr-2 my-2  border border-gray-300">
