               ...
               <aside id="sidebar-multi-level-sidebar border-1-gray-100"
                   ...
                   <div class="h-full px-3 py-4 overflow-y-auto bg-white border-r-gray-100">
                       <ul class="space-y-2 font-medium">
                           <li class="group">
                               <a href="index.php"
                                   class="flex items-center p-2 text-black rounded-lg hover:bg-gray-50 group">
                                   <i
                                       class="las la-tachometer-alt text-gray-600 group-hover:text-gray-900  text-2xl"></i>
                           ...
                           <li>
                               <a href="client.php"
                                   class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-500 group">
