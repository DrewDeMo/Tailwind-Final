                   ...
                   <div class="h-full px-3 py-4 overflow-y-auto bg-white border-r-gray-100">
                       <ul class="space-y-2 font-medium">
                           <li id="activeNav" class="group">
                               <a href="index.php" class="flex items-center p-2 bg-orange-100 text-orange-800 rounded-lg hover:bg-orange-200 group">
                                   <i class="las la-tachometer-alt text-orange-600 group-hover:text-orange-900  text-2xl"></i>
                           ...
                           <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                               ...
                               <i class="las la-angle-down text-gray-600 group-hover:text-gray-900 font-bold  text-xs"></i>
                           </button>
                           <ul id="dropdown-example" class="hidden py-2 space-y-2">
                               <li>
                                   <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 font-normal text-sm">Vendors</a>
                               </li>
                               <li>
                                   <a href="email_list.php" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 font-normal text-sm">E-Mail
                                       List</a>
                               </li>
                               <li>
                                   <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 font-normal text-sm">Promo
                                       Guides</a>
                               </li>
                               <li class="group">
                                   <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 font-normal text-sm group-hover:font-medium duration-400">Heat
                                       Map</a>
                               </li>
                           </ul>
                           </li>
                           ...
                           <ul id="dropdown-2" class="hidden py-2 space-y-2">
                               ...
                               <li class="group">
                                   <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 font-normal text-sm">E-Mail
                                       Main</a>
                               </li>
                               <li>
                                   <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 font-normal text-sm">Promo
                               ...
                               <li class="group">
                                   <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 font-normal text-sm">
                                       Org Chart</a>
                               </li>
                               <li class="group">
                                   <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 font-normal text-sm">
