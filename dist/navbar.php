<div id="topNav" class="w-full h-20">
    <nav>
        <div class="mx-auto h-20 flex items-center px-2 sm:px-6 lg:px-8 text-white">
            ...
            <div class="mt-4 flex items-center p-0 m-0 h-auto">
                <form method="GET">
                    <div id="navSearchBar" class="relative  text-gray-600 focus-within:text-gray-400">
                        ...
                        <input type="search" name="q" class="py-2 text-sm text-white searchBox  border rounded-full pl-10 focus:outline-none" placeholder="Search..." autocomplete="on">
                    </div>
                </form>
            </div>
            ...
            <div class="ml-auto flex items-center space-x-2 fixed top-0 right-2 relative" id="click-section">
                ...
                <div class="z-50 absolute right-0 top-12 invisible w-80 max-w-sm bg-white border border-gray-200 rounded-lg shadow  opacity-0 transition-opacity duration-300" id="popover-content">
                    <button id="dropdownButtonClose" class="text-gray-500  hover:text-opacity-100 transition-opacity duration-700 rounded-lg text-sm p-1.5 absolute right-2 mt-2">
                        <!-- SVG content -->
