    ...
    <nav>
        <div class="mx-auto h-20 flex items-center px-2 sm:px-6 lg:px-8 text-white">
            ...
            <div class="ml-auto flex items-center space-x-2 fixed top-0 right-2 relative" id="click-section">
                <img src="img/user_photo.webp" alt="User Photo"
                    class="rounded-full w-12 h-12 border border-gray-700 shadow" />
                <button id="dropdownButtonOpen" class="w-5 h-5 text-gray-500 cursor-pointer">
                    <!-- SVG content -->
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path
                            d="M10 12a1 1 0 0 1-.7-.29l-3.35-3.44a1 1 0 1 1 1.41-1.41L10 9.58l2.65-2.71a1 1 0 1 1 1.41 1.41l-3.36 3.45a1 1 0 0 1-.7.29z">
                        </path>
                    </svg>
                </button>
                <div class="z-50 absolute right-0 top-12 invisible w-80 max-w-sm bg-white border border-gray-200 rounded-lg shadow  opacity-0 transition-opacity duration-300"
                    id="popover-content">
                    <button id="dropdownButtonClose"
                        class="text-gray-500  hover:text-opacity-100 transition-opacity duration-700 rounded-lg text-sm p-1.5 absolute right-2 mt-2">
                        <!-- SVG content -->
                        <svg class="w-5 h-5 text-opacity-20 hover:text-opacity-100 transition-opacity duration-700"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                            <path
                    ...
                    <div class="flex flex-col items-center pt-10 pb-10">
                        ...
                        <div class="flex mt-4 space-x-3 md:mt-6">
                            <a href="#"
                                ...
                                <svg class="w-[12px] mr-[5px]" xmlns="http://www.w3.org/2000/svg" fill="white"
                            ...
                            <a href="#"
                                ...
                                <svg class="w-[12px] mr-[5px]" xmlns="http://www.w3.org/2000/svg" height="1em"
                                    viewBox="0 0 512 512">
                                    <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                    <path
