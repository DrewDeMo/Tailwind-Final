<div class="w-[90%] m-auto dark:border-gray-700 ml-32">
    <ul
        class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400 border-b border-gray-200">
        <li class="mr-2">
            <a href="#"
