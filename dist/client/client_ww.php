                    ...
                    <div class="p-2 mt-2">
                        <div class="flex items-center justify-between w-full hover:bg-gray-50 duration-400 rounded-lg p-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <h3 class="font-medium ml-4">Benjamin Hartley</h3><span class="bg-ww-blue-sub-50 text-ww-blue-sub-700 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">Owner</span>
                            </div>
                            ...
                            <div class="flex space-x-2">
                                ...
                                <button><i class="las la-envelope text-white font-lg bg-ww-blue-500 hover:bg-ww-blue-600 p-1.5 rounded-lg"></i></button>
                            </div>
                    ...
                    <div class="p-2">
                        <div class="flex items-center justify-between w-full hover:bg-gray-50 duration-400 rounded-lg p-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <h3 class="font-medium ml-4">Clara Jeffries</h3><span class="bg-ww-blue-sub-50 text-ww-blue-sub-700 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">Owner</span>
                            </div>

                            <div class="flex space-x-2">
                                <!-- Two buttons grouped on the right -->
                                <button><i class="las la-copy text-gray-600 font-lg border border-gray-200 hover:bg-gray-100 p-1.5 rounded-lg"></i></button>
                                <button><i class="las la-envelope text-white font-lg bg-ww-blue-600 hover:bg-ww-blue-700 p-1.5 rounded-lg"></i></button>
                            </div>
                    ...
                    <div class="p-2">
                        <div class="flex items-center justify-between w-full hover:bg-gray-50 duration-400 rounded-lg p-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <h3 class="font-medium ml-4">Thomas Whitfield</h3><span class="bg-ww-blue-sub-50 text-ww-blue-sub-700 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">Owner</span>
                            </div>
