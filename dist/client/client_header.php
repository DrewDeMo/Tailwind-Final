<div id="clientHeader" class="flex flex-col mb-6 bg-roofworks-bg p-5 pb-6">
    ...
    <div class="flex items-center mb-4">
        ...
        <div class="flex flex-col items-center mb-12 my-4 w-1/2">
            ...
            <div class="flex flex-row justify-center align-middle">
                ...
                <form class="w-full flex justify-center relative">
                    ...
                    <div
                        class="relative flex items-center w-full px-4 py-1 bg-white/5 border border-white/10 border-opacity-50 rounded-full text-sm font-medium text-white border-fade-in">
                        <div class="flex items-center justify-center w-full">
                            <!-- Logo left fade in -->
                            <img src="img/logos/ww_search_icon.svg" alt="Logo" class="w-8 h-8 mr-2 logo-fade-in" />
                            <input type="search" id="default-search"
                                class="default-search-input block w-full p-4 pl-6  text-white border-0 bg-transparent focus:ring-transparent rounded-full"
                                placeholder="Window World of Altoona" required>
                            <div id="autocomplete-dropdown"
                                class="hidden absolute mt-10 w-full bg-ww-navy-900 border border-ww-navy-700 border-opacity-50 rounded-md shadow-lg">
                            </div>
                            <button type="submit"
                                class="flex items-center justify-center bg-ww-blue-500 duration-800 hover:bg-ww-blue-600 focus:ring-4 focus:outline-none focus:ring-ww-blue-300 font-medium rounded-full text-sm h-8 w-8 px-2 py-2 text-white ml-2">
        ...
        <div class="w-1/2 border-opacity-50 border-white pl-8">
            ...
            <div
                class="flex items-center justify-center w-2/3 px-4 py-1 text-center bg-white/5 border border-white/10 border-opacity-50 rounded-lg text-sm font-medium text-white">
            ...
            <div class="flex items-center my-4 text-white">
                ...
                <div id="client-address">123 Fake Street, Altoona, PA 12345</div>
            </div>
            <div class="flex items-center my-4 text-white">
                <i class="las la-phone text-lg pr-2"></i>
                <div id="client-phone">123-123-1234</div>
            </div>
            <div
