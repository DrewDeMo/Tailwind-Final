        ...
        <div class="flex flex-col items-center mb-12 my-4 w-1/2">
            ...
            <div class="flex flex-row justify-center align-middle">
                ...
                <form class="w-full flex justify-center relative">
                    ...
                    <div
                        class="relative flex items-center w-full px-4 py-1 bg-gray-700 border border-gray-500 border-opacity-50 rounded-full text-sm font-medium text-white border-fade-in">
