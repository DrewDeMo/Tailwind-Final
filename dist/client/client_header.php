        ...
        <div class="flex flex-col items-center mb-12 my-4 w-1/2">
            ...
            <div class="flex flex-row justify-center align-middle">
                ...
                <form class="w-full flex justify-center relative">
                    ...
                    <div class="relative flex items-center w-full px-4 py-1 searchBox rounded-full text-sm font-medium headerText border-fade-in">
        ...
        <div class="w-1/2 border-opacity-50 border-white pl-8">
            ...
            <div class="w-2/3 pb-4">
                <ul class="flex justify-between headerText gap-4">
                    <li class="text-sm flex items-center"><i class='las la-user-circle headerText text-lg mr-2'></i>Benjamin Hartley</li>
                    <li class="text-sm flex items-center"><i class='las la-user-circle headerText text-lg mr-2'></i>Clara Jeffries</li>
                    <li class="text-sm flex items-center"><i class='las la-user-circle headerText text-lg mr-2'></i>Thomas Whitfield</li>
                </ul>
            </div>
        </div>
    </div>
