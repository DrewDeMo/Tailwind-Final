        ...
        <div class="flex flex-col items-center mb-12 my-4 w-1/2">
            ...
            <div class="flex flex-row w-full justify-center align-middle">
                <form class="w-full flex justify-center relative">
                    ...
                    <div
                        class="relative flex items-center w-1/2 px-4 py-1 bg-gray-700 border border-gray-500 border-opacity-50 rounded-full text-sm font-medium text-white">
                        <div class="flex items-center justify-center w-full">
                            <img src="img/logos/CircleW_LineIcon_white.svg" alt="Logo"
                                class="w-8 h-8 mr-2 opacity-40" />
                            <input type="search" id="default-search"
                                class="default-search-input block w-full p-4 pl-6 text-sm text-white border-0 bg-transparent focus:ring-transparent rounded-full"
                                placeholder="Window World of Altoona" required>
                            <div id="autocomplete-dropdown"
                                class="hidden absolute mt-10 w-full bg-gray-700 border border-gray-500 border-opacity-50 rounded-md shadow-lg">
                            </div>
                            <button type="submit"
                                class="flex items-center justify-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm h-8 w-8 px-2 py-2 text-white ml-2">
