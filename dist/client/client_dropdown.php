<div class="flex">
    <button id="states-button" data-dropdown-toggle="dropdown-states"
        class="flex-shrink-0 pr-0 z-10 inline-flex items-center py-1.5 px-2 text-sm font-medium text-center text-white bg-gray-700 border border-gray-600 rounded-l-lg hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-700 border-r"
        type="button">
    ...
    <div id="dropdown-states" class="z-10 hidden bg-gray-700 divide-y divide-gray-600 rounded-lg shadow w-44 h-31">
        <ul class="py-0.5 text-sm text-gray-200" aria-labelledby="states-button">
            <li>
                <button type="button" class="inline-flex w-full px-3.5 py-0.6 text-sm text-gray-200 hover:bg-gray-600">
    ...
    <select id="states"
        class="bg-gray-700 border text-sm border-gray-600 text-white rounded-r-lg border-l focus:ring-gray-500 focus:border-gray-500 block w-full p-1.25 pl-3 pr-5"
