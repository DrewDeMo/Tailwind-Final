<div class="clientNav-tabs">
    <div class="mb-8">
        <nav class="clientNav-tab-nav">
            ...
            <a href="#" data-tab="clientNav-tab4" class="clientNav-tab-link pr-1"><i class="las las la-file-archive text-xl mr-1" style="line-height: 1; vertical-align: bottom;"></i>Assets</a>
