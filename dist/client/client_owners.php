...
<section class="relative rounded-lg border border-gray-300 overflow-hidden">
        ...
        <div class="flex flex-col justify-between h-full">
            ...
            <div class="flex flex-row w-full">
                ...
                <div class="flex-1 text-center my-4 border-r border-gray-200 min-w-0">
                    ...
                    <div class="flex flex-row justify-center gap-4 align-middle w-full mt-4 px-4 sm:px-2">
                        <button
                            class="flex items-center rounded-lg text-sm p-2 px-3 border border-gray-300 text-gray-500 mx-[-0.5] hover:bg-slate-200 ">
                            <box-icon color='#7c89a8' size='16px' name='copy-alt'></box-icon>
                            <span class="ml-1">Copy</span>
                        </button>
                        <button
                            class="flex items-center border border-blue-500 bg-blue-500 duration-500 rounded-lg text-sm font-semibold p-2 px-3 text-white mx-[-0.5] hover:bg-blue-600">
            ...
            <div class="text-center my-4 mb-0 pb-0">
                <a href="mailto:e.johnson@windowworld.com,m.thompson@windowworld.com,s.williams@windowworld.com">
                    <button
                        class="flex align-middle justify-center items-center w-[90%] m-auto bg-blue-500 hover:bg-blue-600 text-gray-100 rounded py-4 mt-4 font-bold">
                        Mail All
