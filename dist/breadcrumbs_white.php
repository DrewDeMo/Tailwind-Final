<div class="w-full px-4">
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            $fontWeights = ['font-bold', 'font-semibold', 'font-medium', 'font-normal'];

            for ($i = 0; $i < count($crumbs); $i++) {
                $cleanedCrumb = preg_replace('/\\.[^.\\s]{3,4}$/', '', $crumbs[$i]);
                ...
                if ($i === count($crumbs) - 1) {
                    ...
                    $fontColor = 'text-gray-300'; // First page (brightest)
                } else {
                    $fontColor = 'text-gray-400'; // Middle pages
                }
